/**
 * athlete Sprites — Evolution stages and customization-ready architecture.
...
export const FIGHTER_STAGES: FighterStage[] = [
  ...
  },
  {
    ...
    sprite: '/athletes/gatekeeper.png',
  ...
  },
  {
    ...
    sprite: '/athletes/rising-star.png',
  ...
  },
  {
    ...
    sprite: '/athletes/hall-of-famer.png',
    defaultGear: ['gloves', 'shorts', 'robe', 'belt', 'boots'],
...
export const DEFAULT_GEAR: GearItem[] = [
  ...
  { id: 'mushroom-cap',      slot: 'headgear', name: 'Mushroom Cap',     rarity: 'rare',      unlockedByRank: 'Prospect',    cssClass: 'gear-mushroom-cap' },
  { id: 'broccoli-shield',   slot: 'gloves',   name: 'Broccoli Shield',  rarity: 'epic',      unlockedByRank: 'Rising Star', cssClass: 'gear-broccoli-shield' },
  { id: 'banana-sword',      slot: 'gloves',   name: 'Banana Sword',     rarity: 'rare',      unlockedByRank: 'Prospect',    cssClass: 'gear-banana-sword' },
  { id: 'carrot-sword',      slot: 'gloves',   name: 'Carrot Sword',     rarity: 'rare',      unlockedByRank: 'Prospect',    cssClass: 'gear-carrot-sword' },
  { id: 'watermelon-shield', slot: 'gloves',   name: 'Watermelon Shield', rarity: 'rare',     unlockedByRank: 'Prospect',    cssClass: 'gear-watermelon-shield' },
