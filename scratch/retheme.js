...
// 3. Fix initialTech mapping in state hook (line 241/242 approx)
...
// 4. Update default activePracticeIdx search to use new IDs
content = content.replace(
...
// 5. Replace MOVE_LIBRARY import in customCombos or update customCombos helper references
content = content.split("MOVE_LIBRARY").join("MOVE_LIBRARY");
