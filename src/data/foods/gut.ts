...
export const gutFoods: Record<string, Technique> = {
  "kombucha": {
    ...
    "coachingCues": [
      "Choose raw, unpasteurized kombucha with low sugar (less than 6g per serving).",
    ...
    "combinations": [
      {
        "name": "Digestive Stimulation (Kombucha + Ginger)",
        "link": "ginger"
      }
    ],
    "relatedTechniques": [
  ...
  "natto": {
    ...
    "coachingCues": [
      "Stir vigorously with chopsticks to create a sticky, stringy mucilage before eating.",
      "Combine with hot rice, mustard, and green onions.",
      "Acknowledge the strong, ammonia-like aroma and slimy texture."
    ],
    "steps": [
    ...
    "combinations": [
      {
        "name": "Bone Mineralization (Natto + Jasmine Rice)",
        "link": "jasmine-rice"
      }
    ],
    "relatedTechniques": [
  ...
  "peppermint": {
    ...
    "coachingCues": [
      "Steep fresh or dried peppermint leaves covered for 10 minutes to trap essential oils.",
      "Excellent caffeine-free soothing drink.",
      "Avoid if you suffer from acid reflux (GERD), as it relaxes the esophageal sphincter."
    ],
    "steps": [
    ...
    "combinations": [
      {
        "name": "Gut Spasm Relief (Peppermint + Ginger)",
        "link": "ginger"
      }
    ],
    "relatedTechniques": [
  ...
  "fennel": {
    ...
    "coachingCues": [
      "Slice raw fennel bulb thinly for salads.",
      "Chew a pinch of fennel seeds after eating to freshen breath and aid digestion.",
      "Roast fennel with olive oil and sea salt for a sweet flavor."
    ],
    "steps": [
