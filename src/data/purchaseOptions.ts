...
export const purchaseOptions: Record<string, PurchaseOption[]> = {
  ...
  'whey-isolate': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$39.99–49.99', unit: 'per 3lb tub', badge: 'best-value', note: 'Kirkland Signature or Optimum Nutrition' },
    ...
    { store: 'GNC', storeType: 'specialty', priceRange: '$34.99–54.99', unit: 'per 2lb tub' },
  ],
  ...
  'eggs': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$6.99–9.99', unit: 'per 2 dozen', note: 'Organic cage-free — best bulk price' },
  ...
  'salmon': [
    { store: 'Costco', storeType: 'warehouse', priceRange: '$8.99–12.99', unit: 'per lb', badge: 'best-value', note: 'Wild-caught Alaskan sockeye in bulk packs' },
  ...
  'oatmeal': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$7.99–9.99', unit: 'per 10lb bag', note: 'Quaker or organic — lasts months' },
  ...
  'chicken-breast': [
    { store: 'Costco', storeType: 'warehouse', priceRange: '$2.99–3.49', unit: 'per lb', badge: 'best-value', note: 'Bulk boneless/skinless — freezes well' },
  ...
  'greek-yogurt': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$5.99–7.99', unit: 'per 48oz tub', note: 'Kirkland or FAGE — best per-oz price' },
  ...
  'quinoa': [
    { store: 'Costco', storeType: 'warehouse', priceRange: '$7.99–9.99', unit: 'per 4lb bag', badge: 'best-value', note: 'Organic tri-color' },
  ...
  'brown-rice': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$8.99–11.99', unit: 'per 15lb bag', note: 'Bulk buy — pennies per serving' },
  ...
  'avocado': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$4.99–6.99', unit: 'per 5-pack', note: 'Hass avocados — great value in season' },
  ...
  'banana': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$1.49–1.99', unit: 'per 3lb bunch' },
  ...
  'lentils': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$6.99–8.99', unit: 'per 5lb bag', note: 'Best bulk price for dry lentils' },
  ...
  'wild-tuna': [
    { store: 'Costco', storeType: 'warehouse', priceRange: '$14.99–18.99', unit: 'per 8-pack (5oz cans)', badge: 'best-value', note: 'Wild Planet or Kirkland albacore' },
  ...
  'coconut-water': [
    { store: 'Costco', storeType: 'warehouse', priceRange: '$8.99–12.99', unit: 'per 12-pack', badge: 'best-value', note: 'Vita Coco or Kirkland' },
  ...
  'pink-salt': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$6.99–8.99', unit: 'per 5lb bag', note: 'Lasts a year for a single household' },
  ...
  'watermelon': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$4.99–6.99', unit: 'per whole melon' },
  ...
  'bone-broth': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$14.99–18.99', unit: 'per 6-pack', badge: 'best-value' },
  ...
  'spinach': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$3.99–5.49', unit: 'per 1lb clamshell', note: 'Organic baby spinach — bulk size' },
  ...
  'blueberries': [
    { store: 'Costco', storeType: 'warehouse', priceRange: '$8.99–12.99', unit: 'per 3lb bag (frozen)', badge: 'best-value', note: 'Organic frozen — best for smoothies' },
  ...
  'sweet-peppers': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$4.99–6.99', unit: 'per 6-pack' },
  ...
  'broccoli': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$4.99–6.49', unit: 'per 3lb bag (frozen)', note: 'Organic frozen florets — always in stock' },
  ...
  'pumpkin-seeds': [
    { store: 'Costco', storeType: 'warehouse', priceRange: '$7.99–9.99', unit: 'per 2lb bag', badge: 'best-value', note: 'Organic raw pepitas' },
  ...
  'brazil-nuts': [
    { store: 'Costco', storeType: 'warehouse', priceRange: '$9.99–13.99', unit: 'per 1.5lb bag', badge: 'best-value' },
  ...
  'sardines': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$11.99–15.99', unit: 'per 8-pack', note: 'Wild-caught in olive oil' },
  ...
  'kimchi': [
    { store: 'Costco', storeType: 'warehouse', priceRange: '$5.99–7.99', unit: 'per 28oz jar', badge: 'best-value', note: 'Jongga brand — traditional recipe' },
  ...
  'ashwagandha': [
    ...
    { store: 'GNC', storeType: 'specialty', priceRange: '$17.99–29.99', unit: 'per 90 caps' },
  ],
  ...
  'creatine-mono': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$19.99–24.99', unit: 'per 1kg', badge: 'best-value', note: 'Bulk size — 200 servings' },
    ...
    { store: 'GNC', storeType: 'specialty', priceRange: '$16.99–27.99', unit: 'per 500g' },
  ],
  ...
  'dark-chocolate': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$9.99–13.99', unit: 'per 6-bar pack', note: 'Hu Kitchen or Alter Eco organic' },
  ...
  'tart-cherry-juice': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$9.99–13.99', unit: 'per 32oz bottle', badge: 'best-value' },
  ...
  'spirulina': [
    ...
    { store: 'GNC', storeType: 'specialty', priceRange: '$12.99–19.99', unit: 'per 100 caps' },
  ],
  ...
  'collagen-peptides': [
    ...
    { store: 'Costco', storeType: 'warehouse', priceRange: '$24.99–29.99', unit: 'per 24oz', badge: 'best-value', note: 'Vital Proteins bulk tub' },
