...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  {
    id: 'gear-mushroom-cap',
    category: 'gear',
    name: 'Mushroom Cap',
    description: 'A cute red-and-white spotted poisonous-looking organic mushroom cap.',
    price: 0,
    icon: 'Crown',
    rarity: 'rare',
    gearSlot: 'headgear',
  ...
  {
    id: 'gear-carrot-sword',
    category: 'gear',
    name: 'Carrot Sword',
    description: 'A long, orange custom sword crafted from a giant farm carrot.',
    price: 0,
    icon: 'Swords',
    rarity: 'rare',
    gearSlot: 'gloves',
  ...
  {
    id: 'gear-watermelon-shield',
    category: 'gear',
    name: 'Watermelon Shield',
    description: 'A thick, heavy shield sliced from a ripe green watermelon.',
    price: 0,
    icon: 'ShieldAlert',
    rarity: 'rare',
    gearSlot: 'gloves',
    gearId: 'watermelon-shield',
  },
